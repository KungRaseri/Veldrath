...
namespace Veldrath.GameClient.Components.Themes;
...
/// Shared between Veldrath.Web and RealmFoundry via the GameClient.Components RCL.
/// <para>
/// ⚠️ Palette hex values are the single source of truth for VDS color tokens.
/// CSS rules reference these values via --mud-palette-* CSS custom properties
/// generated at runtime by MudThemeProvider.
/// </para>
/// </summary>
public static class VeldrathTheme
{
    /// <summary>
    /// Gets the default dark-first MudBlazor theme for Veldrath web applications.
    /// </summary>
