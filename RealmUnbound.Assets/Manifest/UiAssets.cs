...
public static class UiAssets
{
    ...
    public const string Book = "ui/book.png";
    ...
    public const string Button1Hover = "ui/button_01_02.png";
    ...
    public const string FrameBlue = "ui/frame_blue.png";
    /// <summary>Green-tinted frame (positive / ready).</summary>
    public const string FrameGreen = "ui/frame_green.png";
    /// <summary>Red-tinted frame (danger / warning).</summary>
    public const string FrameRed = "ui/frame_red.png";
    ...
    public const string CheckboxChecked1 = "ui/checkbox_01.png";
    ...
    public const string Plank2 = "ui/Plank_02.png";
    /// <summary>Wooden plank label, variant 3.</summary>
    public const string Plank3 = "ui/Plank_03.png";
    /// <summary>Wooden plank label, variant 4.</summary>
    public const string Plank4 = "ui/Plank_04.png";
    ...
    public const string Skull2 = "ui/skull_02.png";
    /// <summary>Sword decoration, variant 1.</summary>
    public const string SwordDecor1 = "ui/sword_01.png";
    /// <summary>Sword decoration, variant 2.</summary>
    public const string SwordDecor2 = "ui/sword_02.png";
    /// <summary>Gear icon.</summary>
    public const string Gear = "ui/gear.png";
    /// <summary>Scroll / letter icon.</summary>
    public const string Letter = "ui/letter.png";
}
