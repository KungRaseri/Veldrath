...
Write-Output "Copying API documentation..."
$ApiDocSource = Join-Path $SolutionRoot "docs\API_SPECIFICATION.md"
$ApiDocDest = Join-Path $PackageRoot "API_SPECIFICATION.md"
Copy-Item -Path $ApiDocSource -Destination $ApiDocDest -Force
Write-Output "[OK] Copied API_SPECIFICATION.md"
Write-Output ""
...
## API Usage
See **API_SPECIFICATION.md** for complete API reference and integration guide.
XML documentation files (``.xml``) are included in each Libraries folder.
...
Write-Output "  - API_SPECIFICATION.md         (API documentation)"
Write-Output ""
