...
public class AccountLinkServiceTests : IDisposable
{
    ...
    private static UserManager<PlayerAccount> BuildUserManager(Veldrath.Server.Data.ApplicationDbContext db)
    {
        ...
        services
            ...
            .AddEntityFrameworkStores<Veldrath.Server.Data.ApplicationDbContext>();
