...
### `ContentSchema.cs` (`Veldrath.Contracts/Content/`)
...
## Veldrath Server Fixes (March 2026)
...
- `Veldrath.Server.Tests.csproj` references Moq and has global usings for `Veldrath.Contracts.Foundry`, `Moq`, `MediatR`
