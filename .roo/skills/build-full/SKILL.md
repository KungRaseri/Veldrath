---
name: build-full
description: Build the complete RealmEngine/Veldrath solution (Realm.Full.slnx) covering all 25+ projects including engine, server, client, tools, and tests. Use when you need to compile the entire monorepo to verify there are no compilation errors.
---

# Skill: build-full

Build the complete RealmEngine/Veldrath monorepo by compiling `Realm.Full.slnx`, which includes all 25+ projects (engine, data, shared, server, client, tools, auth, contracts, assets, fonts, and all 11 test projects).

## Usage

Invoke this skill when you need to:
- Verify the entire codebase compiles without errors
- Check for CS1591 XML doc comment violations
